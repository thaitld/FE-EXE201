...
export default function Register() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      >("/auth/register", { fullName: name, email, password });
          ...
          {!submitted ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="relative space-y-4">
                {error ? (
                  <div className="rounded-xl border border-rose-400/50 bg-rose-950/40 px-4 py-3 text-sm text-rose-200">
                    {error}
                  </div>
                ) : null}
                ...
                <div className="flex items-start gap-2 rounded-xl border border-slate-700/60 bg-slate-900/40 px-4 py-3 text-sm text-slate-200/80">
                  ...
                  />
                  <span>
                    Use a work email so your team can manage access and
                    onboarding later.
                  </span>
                </div>
            ...
            <div className="py-6 text-center">
              ...
              <p className="mt-2 text-sm text-slate-200/80">
                Your MANTO workspace is ready. You can sign in and start setting
                up your team.
              </p>
              <a
                href="#/login"
