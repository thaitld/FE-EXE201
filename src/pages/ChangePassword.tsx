...
export default function ChangePassword() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await apiClient.post<ApiResponse<null>>('/auth/change-password', requestBody)
      ...
      let message = 'Không thể đổi mật khẩu lúc này. Vui lòng kiểm tra lại thông tin.'
      ...
      <main className="relative flex min-h-screen items-center justify-center overflow-hidden text-white" style={{ fontFamily: "'Barlow', sans-serif" }}>
        ...
        <div className="relative w-full max-w-md px-6">
          <div className="liquid-glass relative overflow-hidden rounded-2xl p-8 shadow-[0_0_0_1px_rgba(148,163,184,0.12),0_20px_60px_rgba(0,0,0,0.4)]">
            ...
            <h3 className="relative text-center text-lg font-semibold tracking-tight">Mật khẩu đã thay đổi</h3>
        ...
        <div className="liquid-glass relative overflow-hidden rounded-2xl p-8 shadow-[0_0_0_1px_rgba(148,163,184,0.12),0_20px_60px_rgba(0,0,0,0.4)]">
          ...
          <form onSubmit={handleSubmit} className="relative space-y-4">
            <div className="relative mb-7 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold tracking-tight">Change your password</h3>
                <p className="text-sm text-slate-200/75">Update your password to keep your account secure</p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label className="block text-sm text-slate-200">Current Password</label>
            ...
            {/* Confirm Password */}
            <div className="space-y-2">
              <label className="block text-sm text-slate-200">Confirm New Password</label>
              <div className="relative">
                <Lock className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={16} />
                <input
                ...
                <button
                  ...
                  className="pointer-events-auto absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 transition hover:text-slate-200"
                >
                  {showConfirmPassword ? <Lock size={16} /> : <Lock size={16} />}
                </button>
              </div>
            </div>
